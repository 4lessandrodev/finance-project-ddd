...
import { CreateBenefitCalculationDto } from "@modules/transaction/domain/services/create-benefit-calculation.domain-service";
...
export class PostingToBenefitUseCase implements IUseCase<PostingToBenefitDto, Result<void>>{
	...
	constructor (
		...
		@Inject('CreateBenefitCalculationDomainService')
		private readonly domainService: IDomainService<CreateBenefitCalculationDto, TransactionCalculationValueObject>
	){}
